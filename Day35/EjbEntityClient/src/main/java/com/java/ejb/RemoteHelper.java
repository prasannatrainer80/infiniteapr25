...
public class RemoteHelper {
	...
	public static EmployBeanRemote lookUpRemoteStatelessEmployNew() throws NamingException {
	   ...
	   public static EmployeeBeanRemote lookupRemoteStatelessEmploy() throws NamingException {
		   Context ctx = createInitialContext();
	    ...
	    //    final String appName = "";
	      ...
	      //  final String moduleName = "EJBModule";
	        ...
	        final String beanName = "EmployeeBean";
	        System.out.println(beanName);
	        // the remote view fully qualified class name
	   //     System.out.println(RemoteCalculator.class.getName());
	        final String viewClassName = EmployeeBeanRemote.class.getName();
	        // let's do the lookup
